...
- [ ] `pnpm --dir bindings/node build && node bindings/node/dist/test/server.test.js`、`node bindings/python/tests/test_e2e.py` 通过
- [ ] 跨端矩阵 `node scripts/dist/cross_e2e.js` 6 组合全 PASS（需先 `pnpm --dir scripts build`）
